...
| [`PLANO_OPERACIONAL.md`](PLANO_OPERACIONAL.md)               | Módulo novo e isolado para a operação COM deslocamento: parâmetros gerais e por equipe, custo por hora extra / diária / sem custo, tabela de valores versionada (Super Admin) e o PDF do plano operacional (corpo + Anexo I equipes + Anexo II custos) | 31/ago/2026 — **fases 0–6 no código** (modelo, regras, dados, portão, telas, PDF e navegação); o módulo está descrito no README §8. Fora deste ciclo, como combinado: presença, relatório extraordinário e assinatura digital do plano |
