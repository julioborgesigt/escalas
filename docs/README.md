...
| [`PLANO_DOCUMENTACAO.md`](PLANO_DOCUMENTACAO.md)                                | Plano em fases para encerrar a dívida de documentação e as duplicações remanescentes; a régua é `scripts/inventario-docs.mjs`               | Dev / agente de IA                 |
