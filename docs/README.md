...
| [`PLANO_OPERACIONAL.md`](PLANO_OPERACIONAL.md)               | Módulo novo e isolado para a operação COM deslocamento: parâmetros gerais e por equipe, custo por hora extra / diária / sem custo, tabela de valores versionada (Super Admin) e o PDF do plano operacional (corpo + Anexo I equipes + Anexo II custos) | 30/ago/2026 — plano aprovado, **nada no código**. Fora deste ciclo: presença, relatório extraordinário e assinatura digital do plano |
