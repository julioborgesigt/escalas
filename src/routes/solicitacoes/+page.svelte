		...
		<div class="card-glass rounded-3xl overflow-hidden">
			<div class="overflow-x-auto">
				<table class="table w-full text-sm">
					<thead>
						<tr
							class="text-left text-xs uppercase text-surface-400 border-b border-surface-200 dark:border-white/10"
						>
					...
					<tbody>
						{#each pendentes as s (s.id)}
							...
							>
								...
								<td class="py-3 px-4 text-xs text-surface-400 whitespace-nowrap">
