 ...
 * para a foto de outra pessoa — mesma classe do FLW-DOC-001); o GPS já está
 * DESENHADO no PDF assinado, então recebê-lo de novo deixaria banco e
 * documento discordando sem nada acusar.
 */
