/**
 * Logger estruturado para o servidor.
 * Emite JSON no formato compatível com Cloudflare Workers Logs e Logpush.
 */
...
/**
 * Cria um logger com contexto fixo (ex: requestId, path).
 * Útil para correlacionar todos os logs de uma mesma requisição.
 */
