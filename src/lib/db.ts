...
export async function criarUnidade(db: Database, data: { nome: string; tipo: 'seccional' | 'delegacia'; seccional_id: number | null; tem_plantao: boolean; tem_expediente: boolean; tem_fds: boolean; }) {
	const values: any = { 
		nome: data.nome.trim(),
		tipo: data.tipo,
...
export async function atualizarUnidade(
	db: Database, 
	id: number, 
	data: { nome: string; tipo: 'seccional' | 'delegacia'; seccional_id: number | null; tem_plantao: boolean; tem_expediente: boolean; tem_fds: boolean; }
