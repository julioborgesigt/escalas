<script lang="ts">
	...
	const { checked, disabled = false, onCheckedChange, children }: Props = $props();
</script>
...
<Switch
	...
	class="inline-flex items-center gap-2.5 rounded-full focus-within:ring-2 focus-within:ring-primary-500 focus-within:ring-offset-1 focus-within:ring-offset-surface-50 dark:focus-within:ring-offset-surface-900 {disabled
