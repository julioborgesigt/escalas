...
Arquivos de teste ficam em `src/` com o padrão `*.test.ts`, **sempre** em pastas `__tests__/` junto do código testado (89 arquivos, 915 testes) — convenção verificada no CI. Os principais grupos:
